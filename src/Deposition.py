...
class Deposition:
    ...
    def get_molecular_dynamics_driver(self):
        ...
        driver.settings.update({"deposition_time_picoseconds": self.settings["deposition_time_picoseconds"]})
        driver.settings.update({"relaxation_time_picoseconds": self.settings["relaxation_time_picoseconds"]})
        return driver
