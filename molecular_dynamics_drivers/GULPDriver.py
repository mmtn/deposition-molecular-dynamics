...
class GULPDriver:
    ...
    schema_dictionary = {
        ...
        "deposition_time_ps": And(int, Use(schema_validation.strictly_positive)),
        "relaxation_time_ps": And(int, Use(schema_validation.strictly_positive)),
        Optional("production_time_ps"): Use(schema_validation.reserved_keyword),
